     ...
     <div class="louve-box">
        ...
        <p>
            ...
            de travail et comités. <br />
             Pour rejoindre un comité, envoyer un mail à l'adresse que vous trouverez dans la <a href="/home/comites">liste des comités</a><br />
            <b>Vous serez ajouté à la mail list de ce groupe.</b>
        </p>
     </div>
</div>
<!--
<div class="row landing">
     <div class="louve-box">
        <a href="/home/organisation" class="main">Comment travaillent les comités ?</a>
        <p>
            Google Drive est un disque dur partagé.<br />
            Vous y trouverez tous les documents de travail des groupes et comités. <br/>
            Pour trouver un document, tapez dans la barre de recherche le mot le plus évident.<br/>
            Par exemple, 
            <b> si vous cherchez à joindre un coopérateur, tapez "coopérateur".</b>
        </p>
     </div>
</div>
-->
